<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="#" class="text-light">FEEDBACK SYSTEM</a>
            </div>
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    <div class="image img-cir img-120">
                        <img src="{{asset('resources/assets/images/icon/avatar-big-01.jpg')}}" alt="John Doe" />
                    </div>
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="{{route('admin.faculty')}}">
                                        <i class="fas fa-eye"></i>Manage Faculty</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-list"></i>Feedback
                                <span class="arrow">
                                    <i class="fas fa-angle-down"></i>
                                </span>
                            </a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{route('feedback.index')}}">
                                        <i class="fas fa-eye"></i>Manage Feedback</a>
                                </li>
                                <li>
                                    <a href="{{route('student-feedback.index')}}">
                                        <i class="fas fa-eye"></i>Feedback List</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
